...
export default function Mangoproductpage() {
  ...
  function getdata() {
    setLoading(true);
    axios
      .get("https://tan-frail-hummingbird.cyclic.app/mango")
      .then((res) => {
        console.log(res);
        setdata(res.data);
        setLoading(false);
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Checkbox onChange={handleclick}>Rs 21 to Rs 50 </Checkbox>
          <Checkbox onChange={handleclick}>Rs 101 to Rs 200</Checkbox>
          <Checkbox onChange={handleclick}>Rs 201 to Rs 500</Checkbox>
            ...
            data?.map((ele) => {
              return (
                <>
                  ...
                  >
                    <Text>{ele.brand}</Text>
                    <Link to={`/singleproductpage/${ele.id}`}>
                      <Box m={10}>
                        <img
                          src={ele.image}
                          alt=""
